...
# Hash Checker for verifying is the official release
...
def hash_check(file_path):
    ...
    try:
        rq = requests.get('https://raw.githubusercontent.com/nitrium-dev/files/refs/heads/main/hash.txt')   
        if file_hash == rq.text: #TESTING
